...
const init_files = async () => {
    create_dir_all(paths.ORIGINAL_FILE_PATH)
    create_dir_all(paths.PROCESSED_FILE_PATH)
    create_dir_all(paths.CONFIG_FILE_PATH)
    create_empty_json_file(paths.CONFIGURATIONS_FILE_PATH)
    create_empty_json_file(paths.EXPENDITURE_SETTINGS_PATH)
} 
